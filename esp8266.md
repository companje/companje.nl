...
# tip v Sylvain platformio
Voor 3M spiffs in je config toevoegen `build_flags = -Wl,-Teagle.flash.4m.ld`
`upload_speed = 460800` of `upload_speed = 921600` voor snellere uploads, bij mij lijkt 460800 sneller, denk dat de io wellicht blocked bij hogere snelheden (edited)
