...
write this [flux file](https://github.com/companje/companje.nl/raw/refs/heads/master/downloads/bandit.scp) using [Greaseweazle](https://github.com/keirf/greaseweazle/) to an empty floppy to play the classic Time Bandit game on your Sanyo MBC-550/555.
```
